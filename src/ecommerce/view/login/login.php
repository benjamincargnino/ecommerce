...
<form class="form-horizontal" action="index.php?page=login&action=connection" method="post" name="login" role="form">
...
<form class="form-horizontal" action="index.php?page=login&action=subscription" method="post" name="subscribe" role="form">
    <div class="form-group">
